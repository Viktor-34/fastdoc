...
import { updateProfile, updateWorkspace } from "../profile/actions";
...
interface ProfileSettingsSectionProps {
  initialName: string;
  email: string;
  workspaceData: WorkspaceSettingsData | null;
    ...
    <div className="space-y-8">
      <Card className="rounded-[0.75rem] border-0 shadow-none" style={CARD_STYLE}>
        <CardHeader className="border-b pb-4" style={{ borderColor: FIELD_BORDER_COLOR }}>
          <CardTitle style={{ color: LABEL_COLOR }}>Личные данные</CardTitle>
...
export function CompanySettingsForm({ workspaceData }: CompanySettingsFormProps) {
  const [companyData, setCompanyData] = useState<CompanyData>({
    ...
    signatoryRole: workspaceData?.signatoryRole ?? "",
    signatoryName: workspaceData?.signatoryName ?? "",
    ...
    <div className="space-y-8">
      ...
      <Card className="rounded-[0.75rem] border-0 shadow-none" style={CARD_STYLE}>
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <h3 className="mb-4 font-medium" style={{ color: LABEL_COLOR }}>Подписант документов</h3>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="signatoryRole" style={{ color: LABEL_COLOR }}>Должность</Label>
                <Input
                  id="signatoryRole"
                  value={companyData.signatoryRole}
                  onChange={(e) => updateCompanyField("signatoryRole", e.target.value)}
                  placeholder="Генеральный директор"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="signatoryName" style={{ color: LABEL_COLOR }}>ФИО</Label>
                <Input
                  id="signatoryName"
                  value={companyData.signatoryName}
                  onChange={(e) => updateCompanyField("signatoryName", e.target.value)}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateCompanyField("vatRate", parseInt(e.target.value, 10) || 0)}
              />
            </div>
          </div>
        </CardContent>
